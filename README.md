...
Training repo used to get familiar with Publishing House.

**Owner:** brthomas-9
**Migrated from:** https://github.com/rhpds/brandon-training.git
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/brandon-training1`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/brandon-training1
   ```
3. `cd brandon-training1`
